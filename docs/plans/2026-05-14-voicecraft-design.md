...
> 本文档是 VoiceCraft 全部架构和实现决策的唯一真理源 (Single Source of Truth)。任何后续修改请同步本文件。
...
| 7 | ② VoiceCraftBot | Build Runner 切 `2base_phoenix.yaml`；overlay 入队 |
