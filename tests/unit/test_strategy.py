...
class TestStrategyLibrary:
    ...
    def test_loaded_iac_2base_as_opening(self) -> None:
        ...
        # 2026-05-29 改造：HT 路线比 DT 版早 ~50s，attack_window 改为 6:00
        assert ob.attack_window.open_at == "6:00"
...
class TestPersistentDoctrine:
    ...
    def test_gas_intensity_validation(self) -> None:
        ...
        for valid in ("low", "medium", "high"):
            d = PersistentDoctrine.model_validate(self._minimal_doctrine(gas_intensity=valid))
