...
def library() -> StrategyLibrary:
    ...
    return StrategyLibrary(openings=[op_a, op_b], persistents=[p_a, p_b], races=races)
...
class TestPhaseKindMatching:
    ...
    def test_persistent_phase_rejects_opening_lock(self, library: StrategyLibrary) -> None:
...
class TestRaceMismatch:
    ...
    def test_unregistered_race_allowed(self) -> None:
        ...
        state = StrategyState(
            phase="persistent", current_strategy_id="p_a", opening_completed_at=300
        )
...
class TestApplyTransition:
    ...
    def test_apply_first_persistent_records_completion(self, library: StrategyLibrary) -> None:
