...
def _inject_mock_sc2() -> tuple[Any, ...]:
    ...
    return modules, mock_sharpy_plans, mock_sharpy_plans_acts, mock_sharpy_plans_acts_protoss, mock_sharpy_plans_acts_zerg, mock_sharpy_plans_acts_terran
...
class TestProtossPersistentMacro:
    ...
    def test_expansion_cap_affects_act_count(self) -> None:
        ...
        with patch.dict(sys.modules, modules):
            ...
            acts4 = macro4.acts()
            acts2 = macro2.acts()
        # expansion_cap=4 比 expansion_cap=2 多 2 个 Expand
        assert len(acts4) == len(acts2) + 2
