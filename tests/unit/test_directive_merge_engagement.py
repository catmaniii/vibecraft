    ...
    async def test_defend_converts_to_tactical_objective(
        ...
        director = _make_director(
            ...
            facade,
            {
                ...
                "confidence": 0.95,
                "directives": [
                    {"type": "engagement_constraint", "payload": {"stance": "defend"}}
                ],
            },
        )
    ...
    async def test_retreat_converts_to_tactical_objective(
        ...
        director = _make_director(
            ...
            facade,
            {
                ...
                "confidence": 0.9,
                "directives": [
                    {"type": "engagement_constraint", "payload": {"stance": "retreat"}}
                ],
            },
        )
    ...
    async def test_hold_fallback_direct_stance(
        ...
        director = _make_director(
            ...
            facade,
            {
                ...
                "confidence": 0.9,
                "directives": [
                    {"type": "engagement_constraint", "payload": {"stance": "hold"}}
                ],
            },
        )
    ...
    async def test_free_fallback_direct_stance(
        ...
        director = _make_director(
            ...
            facade,
            {
                ...
                "confidence": 0.9,
                "directives": [
                    {"type": "engagement_constraint", "payload": {"stance": "free"}}
                ],
            },
        )
