...
class MicroSentries(GenericMicro):
    ...
    def group_solve_combat(self, units: Units, current_command: Action) -> Action:
        ...
        self.should_shield_up = self.range_power > 6  # vibecraft: 2026-06-18 lower Guardian Shield threshold 10→6 for smaller engagements
    ...
    def unit_solve_combat(self, unit: Unit, current_command: Action) -> Action:
        ...
        if (
            ...
            if os.environ.get("VIBECRAFT_CASTER_TRACE"):  # vibecraft: 2026-06-18 caster trace log
                logging.getLogger(__name__).warning("CASTERTRACE sentry guardianshield tag=%d", unit.tag)
