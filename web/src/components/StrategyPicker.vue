...
// 两层架构（2026-05-19）：stage 仅区分 opening / persistent。
// 旧 midgame/lategame 都合并到这两类（midgame yamls 已迁到 opening kind）。
...
const ALL_STRATEGIES: StrategyChip[] = [
  ...
  { id: 'iac_2base',                  display: '叉球一波',           race: 'protoss', stage: 'opening' },
  { id: 'dt_drop_iac',                display: '空投隐刀转叉球',     race: 'protoss', stage: 'opening' },
  { id: 'persistent_skytoss',         display: '天空神族',           race: 'protoss', stage: 'persistent' },
  // 虫族 5（4 opening + 1 persistent）
  { id: '12pool',                     display: '12 池 rush',         race: 'zerg',    stage: 'opening' },
  { id: 'macro_hatch',                display: '三矿 macro',         race: 'zerg',    stage: 'opening' },
  { id: 'roach_hydra',                display: '蟑螂刺蛇',           race: 'zerg',    stage: 'opening' },
  { id: 'mutalisk_harass',            display: '飞龙骚扰',           race: 'zerg',    stage: 'opening' },
  { id: 'persistent_brood_corruptor', display: '巢虫腐化运营',       race: 'zerg',    stage: 'persistent' },
  // 人族 5（4 opening + 1 persistent）
  { id: 'marine_rush',                display: '双兵营 rush',        race: 'terran',  stage: 'opening' },
  { id: 'reaper_expand',              display: '死神扩张',           race: 'terran',  stage: 'opening' },
  { id: 'bio_stim',                   display: 'bio 推进',           race: 'terran',  stage: 'opening' },
  { id: 'two_base_tanks',             display: '双矿坦克',           race: 'terran',  stage: 'opening' },
  { id: 'persistent_skyterran',       display: '战巡空军',           race: 'terran',  stage: 'persistent' },
]
