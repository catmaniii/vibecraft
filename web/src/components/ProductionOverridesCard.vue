...
<template>
  <div class="rounded-xl border border-border bg-surface-2 p-3">
    <p class="text-xs font-semibold text-muted uppercase tracking-wider mb-2">{{ t('prodov.title') }}</p>

    <!-- 空态 -->
    <p v-if="orders.length === 0" class="text-xs text-muted italic">{{ t('prodov.empty') }}</p>
